...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # If the candidate does not match any existin candidate, add it to candidate list.
...
with open(file_to_save,"w") as txt_file:
    ...
    # Print the winning candidate, vote count and percentage to the temrinal
    ...
    # Save winning candidate's info to the text file.
